...
interface VonDentzSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
/**
 * Splash Loader customizado para Von Dentz Odontologia
 * - Exibe a marca "VD" e "Von Dentz"
 * - Cores alinhadas com a identidade visual padrão (tons dourados)
 */
const VonDentzSplashLoader = ({ onComplete, duration = 1200 }: VonDentzSplashLoaderProps) => {
  ...
  const words = ['Sorriso', 'Confiança', 'Tecnologia', 'Cuidado'];
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#vonDentzProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="vonDentzProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default VonDentzSplashLoader;
