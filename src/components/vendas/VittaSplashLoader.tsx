...
interface VittaSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
/**
 * Splash Loader customizado para Vitta Odontologia
 * - Exibe a marca "Vitta" com identidade visual dourada
 * - Cores alinhadas com a identidade visual (tons dourados/marrons)
 */
const VittaSplashLoader = ({ onComplete, duration = 1200 }: VittaSplashLoaderProps) => {
  ...
  const words = ['Excelência', 'Confiança', 'Saúde', 'Sorriso'];
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#vittaProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="vittaProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default VittaSplashLoader;
