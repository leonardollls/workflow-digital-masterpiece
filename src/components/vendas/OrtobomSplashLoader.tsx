...
interface OrtobomSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
/**
 * Splash Loader customizado para Ortobom Odontologia
 * - Exibe a marca "Ortobom" ao invés de "Workflow"
 * - Cores alinhadas com a identidade visual da Lidderà (mesmas cores conforme solicitado)
 */
const OrtobomSplashLoader = ({ onComplete, duration = 1200 }: OrtobomSplashLoaderProps) => {
  ...
  const words = ['Confiança', 'Sorriso', 'Excelência', 'Saúde'];
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#ortobomProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="ortobomProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default OrtobomSplashLoader;
