...
interface RobertaBentoSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
/**
 * Splash Loader customizado para Roberta Bento Odontologia
 * - Cores alinhadas com a identidade visual da Envel (tons dourados)
 */
const RobertaBentoSplashLoader = ({ onComplete, duration = 1200 }: RobertaBentoSplashLoaderProps) => {
  ...
  const words = ['Cuidado', 'Qualidade', 'Confiança', 'Sorriso'];
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#robertaBentoProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="robertaBentoProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default RobertaBentoSplashLoader;
