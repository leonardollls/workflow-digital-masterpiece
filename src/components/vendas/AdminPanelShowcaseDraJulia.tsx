...
/**
 * AdminPanelShowcase customizado para Dra. Julia Bisi Comin - Odontologia
 * Com imagem do mockup específico do painel admin
 */
const AdminPanelShowcaseDraJulia = () => {
  ...
  return (
    <section id="admin-panel-section" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Mockup Image - Dra. Julia Bisi Comin Specific */}
        <div className="mb-12 sm:mb-16 flex justify-center">
          <div className="relative group max-w-5xl w-full">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] group-hover:border-white/20 transition-all duration-500">
              <img
                src="/Images/mockups-paineis-ediçao/Create_a_realistic_202602071520.jpeg"
                alt="Painel Administrativo de Edições Visuais - Dra. Julia Bisi Comin Odontologia"
...
export default AdminPanelShowcaseDraJulia;
