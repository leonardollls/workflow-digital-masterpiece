...
const HeroMockup3D = ({ siteUrl, onOpenFullscreen, compact = false, staticMode = false, mockupImage }: HeroMockup3DProps) => {
        ...
        >
          ...
          <div className="relative bg-gradient-to-b from-slate-700 via-slate-800 to-slate-900 rounded-2xl p-3 shadow-2xl">
            ...
            <div className="bg-black rounded-xl p-1 relative overflow-hidden">
              ...
              >
                {/* Site preview - static mode uses image or gradient placeholder, otherwise iframe */}
                {staticMode ? (
                  mockupImage ? (
                    <img
                      src={mockupImage}
                      alt="Preview do site Roberta Bento Odontologia"
