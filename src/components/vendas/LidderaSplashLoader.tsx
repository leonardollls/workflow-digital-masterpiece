 ...
 * - Exibe a marca "Lidderà" ao invés de "Workflow"
 * - Cores alinhadas com a identidade visual da Lidderà
 */
const LidderaSplashLoader = ({ onComplete, duration = 1200 }: LidderaSplashLoaderProps) => {
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#lidderaProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="lidderaProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default LidderaSplashLoader;
