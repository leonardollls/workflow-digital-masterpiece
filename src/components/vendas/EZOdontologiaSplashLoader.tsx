...
interface EZOdontologiaSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
/**
 * Splash Loader customizado para EZ Odontologia
 * - Exibe a marca "EZ Odontologia"
 * - Cores alinhadas com a identidade visual (tons dourados)
 */
const EZOdontologiaSplashLoader = ({ onComplete, duration = 1200 }: EZOdontologiaSplashLoaderProps) => {
  ...
  const words = ['Cuidado', 'Confiança', 'Excelência', 'Sorriso'];
      ...
      <div className={`relative z-10 text-center transition-all duration-500 ${
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            />
            <defs>
              <linearGradient id="ezProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default EZOdontologiaSplashLoader;
