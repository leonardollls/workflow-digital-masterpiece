...
interface InoveSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}

/**
 * Splash Loader customizado para Inove Inteligência Contábil
 * - Exibe a marca "Inove" ao invés de "Workflow"
 * - Cores alinhadas com a identidade visual da Liddera (dourado/azul escuro)
 */
const InoveSplashLoader = ({ onComplete, duration = 1200 }: InoveSplashLoaderProps) => {
  ...
  const words = ['Inteligência', 'Inovação', 'Excelência', 'Parceria'];
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#inoveProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="inoveProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default InoveSplashLoader;
