...
const AdminPanelShowcaseEstadoDaArte = () => {
  ...
  return (
    <section id="admin-panel-section" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 -left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-[#4ABDAC]/10 via-[#4ABDAC]/5 to-transparent rounded-full blur-[120px]" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#4ABDAC]/20 via-[#4ABDAC]/20 to-[#4ABDAC]/20 border border-[#4ABDAC]/40 mb-6 group hover:scale-105 transition-transform duration-300">
            <Settings size={18} className="text-[#4ABDAC] group-hover:rotate-90 transition-transform duration-500" />
            <span className="text-[#4ABDAC] text-sm font-semibold tracking-wide">EXCLUSIVO NO PACOTE</span>
            <div className="w-2 h-2 rounded-full bg-[#4ABDAC] animate-pulse" />
          </div>
          
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
            Painel <span className="bg-gradient-to-r from-[#4ABDAC] via-[#7DD5C9] to-[#4ABDAC] bg-clip-text text-transparent">Administrativo</span>
          </h2>
        ...
        <div className="mb-12 sm:mb-16 flex justify-center">
          <div className="relative group max-w-5xl w-full">
            {/* Glow Effect */}
            <div className="absolute -inset-4 bg-gradient-to-r from-[#4ABDAC]/20 via-[#4ABDAC]/20 to-purple-500/20 rounded-3xl blur-2xl opacity-0 group-hover:opacity-100 transition-all duration-700" />
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] group-hover:border-white/20 transition-all duration-500">
              <img
                src="/Images/mockups-paineis-edi%C3%A7ao/mockup-estado-da-arte.jpeg"
                alt="Painel Administrativo de Edições Visuais - Estado da Arte"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl w-full">
            {features.map((feature, index) => (
              ...
              >
                ...
                {/* Content */}
                <h3 className="text-white font-semibold mb-2 group-hover:text-[#4ABDAC] transition-colors">
                  {feature.title}
                </h3>
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-[#4ABDAC]/10 via-[#4ABDAC]/5 to-purple-500/10 border border-[#4ABDAC]/20">
            <h3 className="flex items-center gap-2 text-white font-semibold mb-4">
              <CheckCircle size={20} className="text-[#4ABDAC]" />
              O que você pode fazer:
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-2 text-white/70 text-sm">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#4ABDAC]" />
                  {benefit}
                </div>
              ))}
            </div>
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <div className="inline-flex items-center gap-4 px-6 py-3 rounded-2xl bg-white/5 border border-white/10">
            <div className="flex items-center gap-2">
              <Code2 size={18} className="text-[#4ABDAC]" />
...
export default AdminPanelShowcaseEstadoDaArte;
