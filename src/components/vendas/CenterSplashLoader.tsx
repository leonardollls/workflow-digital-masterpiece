...
interface CenterSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
const generateParticleStyles = (count: number): ParticleStyle[] => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    // Tons de rose gold / rosa dourado para Center Ortodontia
    const r = 200 + (seed % 30);
    const g = 150 + (seed * 3 % 30);
    const b = 140 + (seed * 2 % 30);
...
/**
 * Splash Loader customizado para Center Ortodontia
 * - Cores alinhadas com a identidade visual (tons rose gold / rosa dourado)
 */
const CenterSplashLoader = ({ onComplete, duration = 1200 }: CenterSplashLoaderProps) => {
  ...
  const words = ['Sorrisos', 'Confiança', 'Saúde', 'Beleza'];
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, #1a1412 0%, #2d2420 50%, #1a1412 100%)',
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(200, 150, 140, 0.15) 0%, transparent 70%)',
          }}
        />
      </div>
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            linear-gradient(rgba(200, 150, 140, 0.5) 1px, transparent 1px),
            linear-gradient(90deg, rgba(200, 150, 140, 0.5) 1px, transparent 1px)
          `,
      ...
      <div className={`relative z-10 text-center transition-all duration-500 ${
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div 
              className="w-full h-full rounded-full border border-[#C8968C]/20"
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#centerProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="centerProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#C8968C" />
                <stop offset="50%" stopColor="#E0B8B0" />
                <stop offset="100%" stopColor="#C8968C" />
              </linearGradient>
            </defs>
          </svg>
          ...
          {/* Logo in Center */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#C8968C] to-[#8B6B5C] flex items-center justify-center shadow-lg logo-pulse">
        ...
        {/* Brand Name */}
        <h1 className="text-2xl sm:text-3xl font-bold mb-2 tracking-wider">
        ...
        <div className="h-7 mb-6">
          <p className="text-base sm:text-lg text-[#C8968C]/80 font-light tracking-wide">
        ...
        <div className="w-56 sm:w-64 mx-auto mb-3">
          <div className="relative h-1 bg-white/5 rounded-full overflow-hidden">
            <div
              ...
              style={{
                width: `${progress}%`,
                background: 'linear-gradient(90deg, #C8968C 0%, #E0B8B0 50%, #C8968C 100%)',
                boxShadow: '0 0 15px rgba(200, 150, 140, 0.4)',
              }}
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-2">
          <span className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-[#C8968C] to-[#E0B8B0] bg-clip-text text-transparent tabular-nums">
            {Math.round(progress)}%
          </span>
        </div>
      ...
      {/* Corner Accents */}
      <div className="absolute top-6 left-6 w-12 h-12 border-l-2 border-t-2 border-[#C8968C]/20 rounded-tl-lg pointer-events-none" />
      <div className="absolute top-6 right-6 w-12 h-12 border-r-2 border-t-2 border-[#C8968C]/20 rounded-tr-lg pointer-events-none" />
      <div className="absolute bottom-6 left-6 w-12 h-12 border-l-2 border-b-2 border-[#C8968C]/20 rounded-bl-lg pointer-events-none" />
      <div className="absolute bottom-6 right-6 w-12 h-12 border-r-2 border-b-2 border-[#C8968C]/20 rounded-br-lg pointer-events-none" />
    </div>
  );
};

export default CenterSplashLoader;
