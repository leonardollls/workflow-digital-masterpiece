...
interface AliceRodriguesSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
/**
 * Splash Loader customizado para Alice Rodrigues Odontologia
 * - Exibe a marca "AR" ao invés de "E"
 * - Cores alinhadas com a identidade visual padrão (tons dourados - mesma paleta Envel)
 */
const AliceRodriguesSplashLoader = ({ onComplete, duration = 1200 }: AliceRodriguesSplashLoaderProps) => {
  ...
  const words = ['Cuidado', 'Tecnologia', 'Sofisticação', 'Sorriso'];
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#aliceProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="aliceProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default AliceRodriguesSplashLoader;
