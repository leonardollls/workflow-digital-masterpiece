...
interface DraJuliaSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
// Função para gerar partículas com valores fixos (baseados no índice)
const generateParticleStyles = (count: number): ParticleStyle[] => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const r = 75 + (seed % 20);
    const g = 100 + (seed * 3 % 30);
    const b = 60 + (seed * 2 % 20);
...
/**
 * Splash Loader customizado para Dra. Julia Bisi Comin - Odontologia
 * Cores alinhadas com a identidade visual verde-oliva/dourado do site
 */
const DraJuliaSplashLoader = ({ onComplete, duration = 1200 }: DraJuliaSplashLoaderProps) => {
  ...
  const words = ['Cuidado', 'Confiança', 'Sorriso', 'Excelência'];
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, #0a0f12 0%, #1a2e1a 50%, #0a0f12 100%)',
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div
          ...
          style={{
            background: 'radial-gradient(circle, rgba(75, 85, 50, 0.15) 0%, transparent 70%)',
          }}
        />
      </div>
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            linear-gradient(rgba(75, 85, 50, 0.5) 1px, transparent 1px),
            linear-gradient(90deg, rgba(75, 85, 50, 0.5) 1px, transparent 1px)
          `,
      ...
      <div className={`relative z-10 text-center transition-all duration-500 ${
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div 
              className="w-full h-full rounded-full border border-[#4B5532]/40"
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#draJuliaProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="draJuliaProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#4B5532" />
                <stop offset="50%" stopColor="#6B7B48" />
                <stop offset="100%" stopColor="#4B5532" />
              </linearGradient>
            </defs>
          </svg>
          ...
          {/* Logo in Center */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#4B5532] to-[#6B7B48] flex items-center justify-center shadow-lg logo-pulse">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-2 tracking-wider">
          <span className="bg-gradient-to-r from-[#4B5532] via-[#8B9B68] to-[#4B5532] bg-clip-text text-transparent">
            Dra. Julia
          </span>
        </h1>
        ...
        <div className="h-7 mb-6">
          <p className="text-base sm:text-lg text-[#8B9B68]/80 font-light tracking-wide">
        ...
        <div className="w-56 sm:w-64 mx-auto mb-3">
          <div className="relative h-1 bg-white/5 rounded-full overflow-hidden">
            <div
              ...
              style={{
                width: `${progress}%`,
                background: 'linear-gradient(90deg, #4B5532 0%, #8B9B68 50%, #4B5532 100%)',
                boxShadow: '0 0 15px rgba(75, 85, 50, 0.4)',
              }}
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-2">
          <span className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-[#4B5532] to-[#8B9B68] bg-clip-text text-transparent tabular-nums">
            {Math.round(progress)}%
          </span>
        </div>
      ...
      {/* Corner Accents */}
      <div className="absolute top-6 left-6 w-12 h-12 border-l-2 border-t-2 border-[#4B5532]/20 rounded-tl-lg pointer-events-none" />
      <div className="absolute top-6 right-6 w-12 h-12 border-r-2 border-t-2 border-[#4B5532]/20 rounded-tr-lg pointer-events-none" />
      <div className="absolute bottom-6 left-6 w-12 h-12 border-l-2 border-b-2 border-[#4B5532]/20 rounded-bl-lg pointer-events-none" />
      <div className="absolute bottom-6 right-6 w-12 h-12 border-r-2 border-b-2 border-[#4B5532]/20 rounded-br-lg pointer-events-none" />
    </div>
  );
};

export default DraJuliaSplashLoader;
