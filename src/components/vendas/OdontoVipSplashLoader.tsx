...
interface OdontoVipSplashLoaderProps {
  onComplete: () => void;
  duration?: number;
}
...
/**
 * Splash Loader customizado para OdontoVip Caxias
 * - Exibe a marca "OdontoVip" com identidade visual da Lidderà (cores douradas)
 * - Palavras-chave do segmento odontológico
 */
const OdontoVipSplashLoader = ({ onComplete, duration = 1200 }: OdontoVipSplashLoaderProps) => {
        ...
        <div className="relative mb-6" style={{ width: '140px', height: '140px', margin: '0 auto', contain: 'layout' }}>
          ...
          <svg className="w-full h-full mx-auto transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="url(#odontovipProgressGradient)"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            />
            <defs>
              <linearGradient id="odontovipProgressGradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default OdontoVipSplashLoader;
