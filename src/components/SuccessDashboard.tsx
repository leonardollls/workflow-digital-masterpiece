    ...
    <section id="centro-comando" className="py-20 bg-gradient-to-br from-workflow-deep via-workflow-deep/95 to-purple-900/90 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           ...
           <div className={`card-workflow bg-gradient-to-br from-gray-900/90 to-gray-800/80 backdrop-blur-xl border-workflow-zen/40 hover:border-workflow-zen/70 transform hover:scale-105 transition-all duration-500 group ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
           ...
           <div className={`card-workflow bg-gradient-to-br from-gray-900/90 to-gray-800/80 backdrop-blur-xl border-workflow-zen/40 hover:border-workflow-zen/70 transform hover:scale-105 transition-all duration-500 group ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.1s' }}>
             <div className="text-center">
               <div className="text-4xl font-bold text-gradient-rainbow mb-3">
                 385%
               </div>
               <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-workflow-zen transition-colors">Impacto Digital</h3>
               <p className="text-workflow-zen/80 text-sm">Crescimento médio dos clientes</p>
               <div className="mt-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full h-2">
           ...
           <div className={`card-workflow bg-gradient-to-br from-gray-900/90 to-gray-800/80 backdrop-blur-xl border-workflow-zen/40 hover:border-workflow-zen/70 transform hover:scale-105 transition-all duration-500 group ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
            <div className="text-center">
              <div className="relative w-28 h-16 mx-auto mb-4">
               ...
               <p className="text-workflow-zen/80 text-sm">Velocidade e otimização</p>
           ...
           <div className={`card-workflow bg-gradient-to-br from-gray-900/90 to-gray-800/80 backdrop-blur-xl border-workflow-zen/40 hover:border-workflow-zen/70 transform hover:scale-105 transition-all duration-500 group ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.3s' }}>
            <div className="text-center">
              <div className="relative w-28 h-16 mx-auto mb-4">
                {/* Enhanced NPS gauge */}
              ...
              <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-workflow-zen transition-colors">NPS Score</h3>
                             <p className="text-workflow-zen/80 text-sm">Satisfação cliente</p>
              <div className="mt-3 flex justify-center">
                <span className="inline-flex items-center gap-1 text-xs bg-green-500/20 text-green-400 px-2 py-1 rounded-full">
           ...
           <div className={`card-workflow bg-gradient-to-br from-gray-900/90 to-gray-800/80 backdrop-blur-xl border-workflow-zen/40 hover:border-workflow-zen/70 transform hover:scale-105 transition-all duration-500 group ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
            <div className="text-center">
              <div className="text-4xl font-bold text-gradient-rainbow mb-3">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-workflow-zen transition-colors">Projetos</h3>
                             <p className="text-workflow-zen/80 text-sm">Entregues com sucesso</p>
           ...
           <div className={`card-workflow bg-gradient-to-br from-gray-900/90 to-gray-800/80 backdrop-blur-xl border-workflow-zen/40 hover:border-workflow-zen/70 transform hover:scale-105 transition-all duration-500 group ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.5s' }}>
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-workflow-zen transition-colors">Metodologia</h3>
                             <p className="text-workflow-zen/80 text-sm">Abordagem científica</p>
              <div className="mt-4 space-y-2">
                                 <div className="flex justify-between items-center text-xs">
                   <span className="text-workflow-zen/80">Hipóteses testadas</span>
                   <span className="text-white font-semibold">847</span>
                 </div>
                 <div className="flex justify-between items-center text-xs">
                   <span className="text-workflow-zen/80">Taxa de acerto</span>
         ...
         <div className={`mt-20 text-center transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
           <div className="inline-flex items-center gap-3 bg-gray-900/80 backdrop-blur-md px-6 py-3 rounded-full mb-8 border border-workflow-zen/30">
             <span className="text-2xl">🌍</span>
             <span className="text-workflow-zen font-semibold">Presença Global</span>
           </div>
           ...
           <div className="relative max-w-6xl mx-auto">
             <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-xl rounded-3xl p-10 border border-workflow-zen/40 hover:border-workflow-zen/60 transition-all duration-500 shadow-2xl">
               {/* World Map Visual */}
               <div className="relative mb-12">
                 <div className="text-8xl mb-4 animate-pulse filter drop-shadow-lg">🌍</div>
                 <div className="absolute inset-0 flex items-center justify-center">
                   <div className="w-32 h-32 bg-gradient-to-r from-workflow-zen/20 to-purple-500/20 rounded-full animate-ping"></div>
                 </div>
               </div>
               ...
               <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                 <div className="text-center">
                   ...
                   <div className="text-workflow-zen/80 text-sm">Clientes Ativos</div>
                 </div>
                 <div className="text-center">
                   <div className="text-3xl font-bold text-gradient-rainbow">15+</div>
                   <div className="text-workflow-zen/80 text-sm">Países</div>
                 </div>
                 <div className="text-center">
                   <div className="text-3xl font-bold text-gradient-rainbow">24/7</div>
                   <div className="text-workflow-zen/80 text-sm">Suporte Global</div>
                 </div>
                 <div className="text-center">
                   <div className="text-3xl font-bold text-gradient-rainbow">99.9%</div>
                   <div className="text-workflow-zen/80 text-sm">Uptime</div>
                 </div>
               </div>

               {/* Enhanced Regional Data */}
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
                 <div className="group cursor-pointer bg-gradient-to-br from-gray-800/50 to-gray-700/30 rounded-2xl p-6 hover:scale-105 transition-all duration-300 border border-workflow-zen/20 hover:border-workflow-zen/40">
                   <div className="text-4xl mb-3">🇧🇷</div>
                   <div className="text-xl font-bold text-gradient-zen group-hover:scale-110 transition-transform">Brasil</div>
                   <div className="text-white/80 mb-3 text-lg font-semibold">127 clientes</div>
                   <div className="w-full bg-workflow-zen/20 h-3 rounded-full overflow-hidden mb-3">
                   ...
                   <div className="text-xs text-workflow-zen/80 bg-workflow-zen/10 px-3 py-1 rounded-full">Mercado Principal</div>
                   <div className="mt-3 text-green-400 text-sm font-semibold">↗ +23% este ano</div>
                 </div>
                 
                 <div className="group cursor-pointer bg-gradient-to-br from-gray-800/50 to-gray-700/30 rounded-2xl p-6 hover:scale-105 transition-all duration-300 border border-workflow-zen/20 hover:border-workflow-zen/40">
                   <div className="text-4xl mb-3">🇺🇸</div>
                   <div className="text-xl font-bold text-gradient-zen group-hover:scale-110 transition-transform">EUA</div>
                   <div className="text-white/80 mb-3 text-lg font-semibold">34 clientes</div>
                   <div className="w-full bg-workflow-zen/20 h-3 rounded-full overflow-hidden mb-3">
                     <div className="bg-gradient-to-r from-blue-400 to-cyan-400 h-full rounded-full w-3/4 animate-[slideIn_2.2s_ease-out]"></div>
                   </div>
                   <div className="text-xs text-blue-300/80 bg-blue-500/10 px-3 py-1 rounded-full">Expansão Ativa</div>
                   <div className="mt-3 text-green-400 text-sm font-semibold">↗ +156% este ano</div>
                 </div>
                 
                 <div className="group cursor-pointer bg-gradient-to-br from-gray-800/50 to-gray-700/30 rounded-2xl p-6 hover:scale-105 transition-all duration-300 border border-workflow-zen/20 hover:border-workflow-zen/40">
                   <div className="text-4xl mb-3">🇪🇺</div>
                   <div className="text-xl font-bold text-gradient-zen group-hover:scale-110 transition-transform">Europa</div>
                   <div className="text-white/80 mb-3 text-lg font-semibold">18 clientes</div>
                   <div className="w-full bg-workflow-zen/20 h-3 rounded-full overflow-hidden mb-3">
                     <div className="bg-gradient-to-r from-green-400 to-emerald-400 h-full rounded-full w-1/2 animate-[slideIn_2.4s_ease-out]"></div>
                   </div>
                   <div className="text-xs text-green-300/80 bg-green-500/10 px-3 py-1 rounded-full">Crescimento</div>
                   <div className="mt-3 text-green-400 text-sm font-semibold">↗ +89% este ano</div>
                 </div>
                 
                 <div className="group cursor-pointer bg-gradient-to-br from-gray-800/50 to-gray-700/30 rounded-2xl p-6 hover:scale-105 transition-all duration-300 border border-workflow-zen/20 hover:border-workflow-zen/40">
                   <div className="text-4xl mb-3">🌏</div>
                   <div className="text-xl font-bold text-gradient-zen group-hover:scale-110 transition-transform">Ásia & Outros</div>
                   <div className="text-white/80 mb-3 text-lg font-semibold">12 clientes</div>
                   <div className="w-full bg-workflow-zen/20 h-3 rounded-full overflow-hidden mb-3">
                     <div className="bg-gradient-to-r from-orange-400 to-red-400 h-full rounded-full w-1/3 animate-[slideIn_2.6s_ease-out]"></div>
                   </div>
                   <div className="text-xs text-orange-300/80 bg-orange-500/10 px-3 py-1 rounded-full">Emergentes</div>
                   <div className="mt-3 text-green-400 text-sm font-semibold">↗ +67% este ano</div>
                 </div>
               </div>

               {/* Global Impact Statement */}
               <div className="mt-10 text-center">
                 <div className="inline-flex items-center gap-2 bg-gradient-to-r from-workflow-zen/20 to-purple-500/20 px-6 py-3 rounded-full border border-workflow-zen/30">
                   <span className="text-workflow-zen/90 font-semibold">🚀 Impacto Global:</span>
                   <span className="text-white font-bold">+2.5M vidas impactadas digitalmente</span>
                 </div>
               </div>
             </div>
           </div>
