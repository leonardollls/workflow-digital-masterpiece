...
const VendasVitta = lazy(() => import("./pages/VendasVitta"));
const VendasRobertaBento = lazy(() => import("./pages/VendasRobertaBento"));
const VendasPergher = lazy(() => import("./pages/VendasPergher"));
const VendasAliceRodrigues = lazy(() => import("./pages/VendasAliceRodrigues"));
const VendasBeldentale = lazy(() => import("./pages/VendasBeldentale"));
const VendasRevitalle = lazy(() => import("./pages/VendasRevitalle"));
        ...
        <TooltipProvider>
          ...
          <Suspense fallback={
            ...
            <Routes>
              ...
              <Route path="/site/drajulia" element={<Navigate to="/site/drajulia-odontologia" replace />} />
              ...
              <Route path="/site/vitta" element={<Navigate to="/site/vitta-odontologia" replace />} />
              <Route path="/site/vitta-odontologia" element={<VendasVitta />} />
              <Route path="/site/robertabento" element={<Navigate to="/site/robertabento-odontologia" replace />} />
              <Route path="/site/robertabento-odontologia" element={<VendasRobertaBento />} />
              <Route path="/site/pergher" element={<Navigate to="/site/pergher-odontologia" replace />} />
              <Route path="/site/pergher-odontologia" element={<VendasPergher />} />
              <Route path="/site/alice-rodrigues" element={<Navigate to="/site/alice-rodrigues-odontologia" replace />} />
              <Route path="/site/alice-rodrigues-odontologia" element={<VendasAliceRodrigues />} />
              <Route path="/site/beldentale" element={<Navigate to="/site/beldentale-odontologia" replace />} />
              <Route path="/site/beldentale-odontologia" element={<VendasBeldentale />} />
              <Route path="/site/revitalle" element={<Navigate to="/site/revitalle-odontologia" replace />} />
              <Route path="/site/revitalle-odontologia" element={<VendasRevitalle />} />
              {/* Checkout Routes */}
