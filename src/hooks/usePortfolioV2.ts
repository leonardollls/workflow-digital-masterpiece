...
const fallbackProjects: PortfolioProject[] = [
  ...
  },
  {
    id: '5',
    title: 'Promptizi',
    description: 'Agência de IA que automatiza processos, simplifica rotinas e impulsiona resultados com inteligência artificial. Agentes de automação, conteúdo e atendimento.',
    category: 'Tecnologia/AI',
    url: 'https://www.promptizi.com.br/',
    thumbnail_url: '/Images/capas-sites/Promptizi.webp',
    order_index: 5,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  ...
  {
    id: '8',
    title: 'J. Negrão Consultoria',
    description: 'Consultoria empresarial e BPO financeiro para PMEs. Aumento de lucros em até 20%, precificação inteligente e economia de 80% em custos de pessoal.',
    category: 'Consultoria',
    url: 'https://www.jnegraoconsultoria.com/',
    thumbnail_url: '/Images/capas-sites/J. Negrão Consultoria.webp',
    order_index: 8,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  ...
  {
    id: '15',
    title: 'Rei do Crédito',
    description: 'Líder em antecipação FGTS, Crédito Bolsa Família e empréstimo CLT. +100 milhões liberados, 6 lojas em SC e nota 5.0 no Google.',
    category: 'Financeiro',
    url: 'https://reidocreditoficial.com.br/',
    thumbnail_url: '/Images/capas-sites/Rei do Crédito.webp',
    order_index: 15,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  ...
  {
    id: '21',
    title: 'MRA Advogados Associados',
    description: 'Escritório de advocacia com décadas de atuação em Direito Previdenciário, Trabalhista, Cível, Família e Criminal. Unidades em São Jerônimo e Guaíba-RS.',
    category: 'Advocacia',
    url: 'https://mraadvogadosassociados.com.br/',
    thumbnail_url: '/Images/capas-sites/MRA Advogados Associados.webp',
    order_index: 21,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    id: '22',
    title: 'CognusCore',
    description: 'Diagnóstico executivo para empresas que mede compatibilidade pessoa-cargo com 93% de precisão. +140 empresas de grande porte já utilizaram.',
    category: 'Consultoria',
    url: 'https://cognuscore.com/',
    thumbnail_url: '/Images/capas-sites/CognusCore.webp',
    order_index: 22,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
