...
const fallbackProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    thumbnail_url: '/Images/capas-sites/Envel-Contabilidade.webp',
    order_index: 5,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  ...
  {
    id: '16',
    title: 'Atração Mídias',
    description: 'Assessoria de Marketing Completa que atua de ponta a ponta. Branding estratégico, funil de vendas completo, gestão de tráfego pago e acompanhamento contínuo. Mais de 40 contas gerenciadas e foco total em resultados previsíveis.',
    category: 'Marketing/Agência',
    url: 'https://atracaomidias.com.br/',
    thumbnail_url: '/Images/capas-sites/Atração Mídias.webp',
    order_index: 16,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  ...
  {
    id: '24',
    title: 'Faculdade Phorte',
    description: 'Instituição de ensino superior especializada em Educação Física com formações avançadas, pós-graduações e +50 cursos para profissionais da área.',
    category: 'Educação',
  ...
  },
  {
    id: '25',
    title: 'RecyLoop',
    description: 'Startup de sustentabilidade que transforma resíduos têxteis em blocos de gesso inovadores e resistentes, promovendo economia circular na construção civil.',
    category: 'Tecnologia',
    url: 'https://recyloop.com.br/',
    thumbnail_url: '/Images/capas-sites/RecyLoop.webp',
    order_index: 25,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
