...
import PergherSplashLoader from '@/components/vendas/PergherSplashLoader';
...
const AdminPanelShowcasePergher = lazy(() => import('@/components/vendas/AdminPanelShowcasePergher'));
const HostingBonusSection = lazy(() => import('@/components/vendas/HostingBonusSection'));

type DeviceType = 'desktop' | 'mobile';

const SectionFallback = () => (
  <div className="min-h-[200px] animate-pulse rounded-2xl bg-slate-800/30" aria-hidden="true" />
);
...
const VendasPergher = () => {
  ...
  const SITE_URL = 'https://pergher-odontologia.vercel.app/';
  const PAYMENT_LINK = 'https://wa.me/555199437916';

  // Recursos específicos do site Pergher Odontologia para o comparativo
  const pergherComparisons = [
    ...
    { feature: 'Agendamento Online via WhatsApp', oldSite: false, newSite: true },
    { feature: 'Perfis Profissionais Detalhados', oldSite: false, newSite: true },
    { feature: 'Avaliações de Pacientes (Google)', oldSite: false, newSite: true },
    { feature: 'Galeria de Serviços Odontológicos', oldSite: false, newSite: true },
    { feature: 'Mapa e Localização Integrados', oldSite: false, newSite: true },
  ...
  // Dark background and body scroll lock (single effect)
  useEffect(() => {
  ...
  // Header visibility based on scroll (rAF ticking pattern)
  useEffect(() => {
    let ticking = false;
    const handleScroll = () => {
      if (ticking) return;
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e solidez, refletindo os 40+ anos de tradição da Pergher Odontologia.',
  ...
  return (
    <>
      ...
      {showSplash && (
        <PergherSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
            ...
            <div className="relative flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate text-sm sm:text-base">Pergher Odontologia</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl min-h-0 relative">
              ...
              >
                ...
                >
                  <iframe
                    src={SITE_URL}
                    title="Preview Pergher Odontologia"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">Pergher</span>
            ...
            <div className="max-w-6xl mx-auto">
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete a <strong className="text-white/90">excelência e tradição</strong> de mais de 40 anos da Pergher Odontologia.
                </p>

                {/* Hero Mockup 3D - Single instance with static mode */}
                <HeroMockup3D
                  siteUrl={SITE_URL}
                  onOpenFullscreen={() => setIsPreviewOpen(true)}
                  staticMode
                  mockupImage="/Images/mockups-3d/pergher-mockup-desktop.webp"
                />
          ...
          <LazySection rootMargin="400px" minHeight="600px">
            <section id="preview-section" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
              <div className="max-w-7xl mx-auto">
                ...
                <div className="hidden md:grid grid-cols-2 lg:grid-cols-5 gap-6 mb-8 items-stretch">
                  <div className="flex">
                    <Suspense fallback={<SectionFallback />}>
                  ...
                  <div className="flex sm:col-span-2 lg:col-span-1 justify-center">
                    <Suspense fallback={<SectionFallback />}>
                      <Mockup3D
                        ...
                        staticMode
                        mockupImage="/Images/mockups-3d/pergher-mockup-mobile.webp"
                      />
                    </Suspense>
                  </div>
                </div>

                {/* Row 3: Feature Comparison */}
                <div className="mb-8">
                  <h3 className="text-white font-semibold mb-4 text-center">Comparativo de Recursos</h3>
                  <Suspense fallback={<SectionFallback />}>
                    <FeatureComparison comparisons={pergherComparisons} />
                  </Suspense>
                </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Com mais de 40 anos de tradição, a Pergher Odontologia merece um site que transmita toda essa experiência e profissionalismo aos pacientes."
                </p>
