...
import RevitalleSplashLoader from '@/components/vendas/RevitalleSplashLoader';
...
const AdminPanelShowcaseRevitalle = lazy(() => import('@/components/vendas/AdminPanelShowcaseRevitalle'));
...
const VendasRevitalle = () => {
  ...
  const SITE_URL = 'https://revitalle-odonto.vercel.app/';
  const PAYMENT_LINK = 'https://wa.me/555199437916';

  const revitalleComparisons = [
    ...
    { feature: 'Feed do Instagram Integrado', oldSite: false, newSite: true },
    { feature: 'Mapa e Localização Integrados', oldSite: false, newSite: true },
    { feature: 'Tema Claro/Escuro', oldSite: false, newSite: true },
    { feature: 'Barra de Anúncios Animada', oldSite: false, newSite: true },
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e excelência, refletindo os mais de 10 anos da Revitalle em Caxias do Sul.',
  ...
  return (
    <>
      {showSplash && (
        <RevitalleSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
            ...
            <div className="relative flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-[#122737] to-[#D4A574] flex items-center justify-center flex-shrink-0">
                  <span className="text-white font-bold text-xs sm:text-sm">RV</span>
                </div>
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate text-sm sm:text-base">Revitalle Odontologia</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl min-h-0 relative">
              ...
              >
                ...
                <div className="w-full h-full relative flex-1 min-h-0" style={{ overflow: 'hidden' }}>
                  <iframe
                    src={SITE_URL}
                    title="Preview Revitalle Odontologia"
            ...
            <div className="flex items-center justify-between gap-4">
              <button onClick={scrollToTop} className="flex items-center gap-3 group" aria-label="Voltar ao topo">
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">Revitalle</span>
              ...
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                  ...
                  <span className="bg-gradient-to-r from-[#D4A574] via-[#E8C9A9] to-[#D4A574] bg-clip-text text-transparent">
                    Revitalle Odontologia
                  </span>
                </h1>

                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete a <strong className="text-white/90">excelência e tradição</strong> da Revitalle Odontologia em cada detalhe.
                </p>
                ...
                <HeroMockup3D 
                  ...
                  staticMode
                  mockupImage="/Images/mockups-3d/revitalle-mockup-desktop.webp"
                />
              </div>
            </div>
          </section>
            ...
            <section id="preview-section" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
              <div className="max-w-7xl mx-auto">
                  ...
                  <Suspense fallback={<SectionFallback height="200px" />}>
                    ...
                    <div className="flex sm:col-span-2 lg:col-span-1 justify-center">
                      <Mockup3D 
                        siteUrl={SITE_URL} 
                        staticMode
                        mockupImage="/Images/mockups-3d/revitalle-mockup-mobile.webp"
                        onOpenFullscreen={() => {
                          setDevice('mobile');
                ...
                <div className="mb-8">
                  ...
                  <Suspense fallback={<SectionFallback height="300px" />}>
                    <FeatureComparison comparisons={revitalleComparisons} />
                  </Suspense>
                </div>
            ...
            <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Com mais de 10 anos de excelência em odontologia, a Revitalle merece um site que transmita toda essa tradição e qualidade aos pacientes de Caxias do Sul."
                </p>
...
export default VendasRevitalle;
