...
import BeldentaleSplashLoader from '@/components/vendas/BeldentaleSplashLoader';
...
const AdminPanelShowcaseBeldentale = lazy(() => import('@/components/vendas/AdminPanelShowcaseBeldentale'));
const HostingBonusSection = lazy(() => import('@/components/vendas/HostingBonusSection'));

type DeviceType = 'desktop' | 'mobile';

const SectionFallback = () => <div className="min-h-[200px] animate-pulse bg-white/5 rounded-2xl" aria-hidden="true" />;

const VendasBeldentale = () => {
  ...
  const SITE_URL = 'https://beldentale.vercel.app/';
  const PAYMENT_LINK = 'https://wa.me/555199437916';

  const beldentaleComparisons = [
    ...
    { feature: 'Catálogo de Tratamentos', oldSite: false, newSite: true },
    { feature: 'Avaliações do Google Integradas', oldSite: false, newSite: true },
    { feature: 'Galeria Instagram Integrada', oldSite: false, newSite: true },
    { feature: 'Agendamento Online', oldSite: false, newSite: true },
    { feature: 'Mapa Interativo de Localização', oldSite: false, newSite: true },
  ...
  useEffect(() => {
    if (isPreviewOpen) setIframeLoading(true);
  }, [isPreviewOpen]);
  ...
  const getDeviceWidth = (): string => {
    return device === 'mobile' ? 'w-full max-w-[100vw] sm:max-w-[480px]' : 'max-w-[1600px]';
  };

  const getDeviceHeight = (): string => {
    return device === 'mobile' ? 'h-full min-h-[calc(100vh-80px)] max-h-[calc(100vh-80px)] sm:max-h-[932px]' : 'max-h-full';
  };
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e modernidade, refletindo os 20+ anos de experiência da Beldentale.',
      accent: 'from-blue-500 to-cyan-500'
    },
    {
      icon: MessageCircle,
      title: '+60% Mais Contatos',
      description: 'Integração inteligente com WhatsApp e agendamento otimizado para conversão de visitantes em pacientes.',
      accent: 'from-green-500 to-emerald-500'
    },
    {
      icon: Search,
      title: 'Melhor no Google',
      description: 'SEO otimizado para aparecer nas primeiras posições nas buscas locais por clínicas odontológicas.',
  ...
  return (
    <>
      ...
      {showSplash && (
        <BeldentaleSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
            ...
            <div className="relative flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate text-sm sm:text-base">Beldentale Clínica Odontológica</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl min-h-0 relative">
              ...
              >
                ...
                >
                  <iframe
                    src={SITE_URL}
                    title="Preview Beldentale Clínica Odontológica"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">Beldentale</span>
      ...
      <div className={`min-h-screen relative transition-opacity duration-700 bg-slate-950 ${contentReady ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <main className="relative z-10">
              ...
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                  ...
                  <span className="bg-gradient-to-r from-[#D4A574] via-[#E8C9A9] to-[#D4A574] bg-clip-text text-transparent">
                    Beldentale Odontologia
                  </span>
                </h1>

                {/* Subtitle */}
                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete a <strong className="text-white/90">excelência e tradição</strong> de mais de 20 anos da Beldentale Clínica Odontológica.
                </p>

                {/* Hero Mockup 3D - Single static image */}
                <div className="mb-8">
                  <HeroMockup3D 
                    staticMode 
                    mockupImage="/Images/mockups-3d/dbeldentale-mockup-desktop.webp"
                    siteUrl={SITE_URL} 
          ...
          <LazySection rootMargin="400px" minHeight="600px" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <section className="max-w-7xl mx-auto">
              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className={`hidden md:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-8 transition-all duration-1000 items-stretch ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <div className="flex">
                  <Suspense fallback={<SectionFallback />}>
                ...
                <div className="flex sm:col-span-2 lg:col-span-1 justify-center">
                  <Suspense fallback={<SectionFallback />}>
                    <Mockup3D 
                      staticMode 
                      mockupImage="/Images/mockups-3d/beldentale-mockup-mobile.webp"
                      siteUrl={SITE_URL} 
                      onOpenFullscreen={() => {
                        setDevice('mobile');
                        setIsPreviewOpen(true);
              ...
              <div className={`mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <Suspense fallback={<SectionFallback />}>
                  <FeatureComparison comparisons={beldentaleComparisons} />
                </Suspense>
              </div>
          ...
          <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative">
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Com mais de 20 anos de tradição, a Beldentale merece um site que transmita toda essa experiência e profissionalismo aos pacientes."
                </p>
...
export default VendasBeldentale;
