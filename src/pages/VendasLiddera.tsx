...
const VendasLiddera = () => {
  ...
  const stats = [
    { value: '35+', label: 'Anos de Experiência', accent: 'from-amber-500 to-orange-600' },
    { value: '+40%', label: 'Mais Credibilidade', accent: 'from-blue-500 to-indigo-600' },
    { value: '+60%', label: 'Mais Contatos', accent: 'from-green-500 to-emerald-600' },
    { value: '100%', label: 'Responsivo', accent: 'from-purple-500 to-violet-600' },
  ];
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl">
              <div 
                className={`relative w-full h-full ${getDeviceWidth()} transition-all duration-500 mx-auto`}
                style={{
