...
import {
  ...
  LogoCarousel,
  DeveloperShowcase,
  EZOdontologiaSplashLoader,
  AdminPanelShowcaseEZ,
...
const VendasEZ = () => {
  ...
  const SITE_URL = 'https://ez-odontologia.vercel.app/';
  const PAYMENT_LINK = 'https://wa.me/555199437916';

  // Recursos específicos do site EZ Odontologia para o comparativo
  const ezComparisons = [
    ...
    { feature: 'Galeria de Especialistas', oldSite: false, newSite: true },
    { feature: 'Agendamento via WhatsApp', oldSite: false, newSite: true },
    { feature: 'Seção de Serviços Odontológicos', oldSite: false, newSite: true },
    { feature: 'Avaliações de Pacientes', oldSite: false, newSite: true },
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e excelência em cuidados odontológicos.',
    ...
    },
    {
      ...
      description: 'SEO otimizado para aparecer nas primeiras posições nas buscas por dentistas em Caxias do Sul.',
  ...
  return (
    <>
      ...
      {showSplash && (
        <EZOdontologiaSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
            ...
            <div className="relative flex items-center justify-between gap-4 px-4 py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate">EZ Odontologia</h2>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">EZ Odontologia</span>
            ...
            <div className="max-w-6xl mx-auto">
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete a <strong className="text-white/90">excelência e cuidado</strong> da sua clínica odontológica em Caxias do Sul.
                </p>
          ...
          <section id="preview-section" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <div className="max-w-7xl mx-auto">
              ...
              <div className={`mb-8 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <FeatureComparison comparisons={ezComparisons} />
              </div>
                    ...
                    <div className="relative z-10 p-8 sm:p-12">
                      ...
                      <div className="text-center mb-10 group-hover:scale-[1.02] transition-transform duration-500">
                        ...
                        <p className="text-white/70 text-lg mt-3 font-medium max-w-lg mx-auto">
                          Entre em contato e receba uma proposta personalizada para o site da sua clínica odontológica
                        </p>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Sua clínica odontológica merece um site que transmita toda a excelência e cuidado que seus pacientes encontram no consultório."
                </p>
