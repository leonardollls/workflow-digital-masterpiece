...
import VittaSplashLoader from '@/components/vendas/VittaSplashLoader';
...
const AdminPanelShowcaseVitta = lazy(() => import('@/components/vendas/AdminPanelShowcaseVitta'));
...
const VendasVitta = () => {
  ...
  const SITE_URL = 'https://vitta-odontologia.vercel.app/';
  const PAYMENT_LINK = 'https://wa.me/555199437916';

  // Recursos específicos do site Vitta para o comparativo
  const vittaComparisons = [
    ...
    { feature: 'Formulário de Agendamento Online', oldSite: false, newSite: true },
    { feature: 'Galeria de Serviços Interativa', oldSite: false, newSite: true },
    { feature: 'Equipe com Perfis Detalhados', oldSite: false, newSite: true },
    { feature: 'Depoimentos de Pacientes Reais', oldSite: false, newSite: true },
    { feature: 'FAQ com Perguntas Frequentes', oldSite: false, newSite: true },
  ...
  // Reset iframe loading, lock body scroll when modal open
  useEffect(() => {
    if (isPreviewOpen) {
  ...
  // Handle escape key (preview + mobile menu)
  useEffect(() => {
  ...
  // Header visibility based on scroll (rAF ticking)
  useEffect(() => {
    let ticking = false;
    const handleScroll = () => {
      if (ticking) return;
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e excelência, refletindo a qualidade da Vitta Odontologia.',
      accent: 'from-blue-500 to-cyan-500'
    },
    {
      icon: MessageCircle,
      title: '+60% Mais Contatos',
      description: 'Integração inteligente com WhatsApp e formulário de agendamento otimizado para conversão de pacientes.',
  ...
  return (
    <>
      ...
      {showSplash && (
        <VittaSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
            ...
            <div className="relative flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate text-sm sm:text-base">Vitta Odontologia</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl min-h-0 relative">
              ...
              >
                ...
                >
                  <iframe
                    src={SITE_URL}
                    title="Preview Vitta Odontologia"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">Vitta</span>
            ...
            <div className="max-w-6xl mx-auto">
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete a <strong className="text-white/90">excelência e especialização</strong> da Vitta Odontologia Especializada.
                </p>
                ...
                <HeroMockup3D
                  ...
                  staticMode
                  mockupImage="/Images/mockups-3d/vitta-mockup-desktop.webp"
                />
              ...
              <div className="max-w-7xl mx-auto">
                  ...
                  <div className="flex sm:col-span-2 lg:col-span-1 justify-center">
                    <Suspense fallback={<SectionFallback height="200px" />}>
                      <Mockup3D
                        ...
                        staticMode
                        mockupImage="/Images/mockups-3d/vitta-mockup-mobile.webp"
                      />
                    </Suspense>
                  </div>
                </div>
                ...
                <div className={`mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  ...
                  <Suspense fallback={<SectionFallback height="300px" />}>
                    <FeatureComparison comparisons={vittaComparisons} />
                  </Suspense>
                </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "A Vitta Odontologia merece um site que transmita toda a excelência e especialização em cada detalhe do atendimento aos pacientes."
                </p>
