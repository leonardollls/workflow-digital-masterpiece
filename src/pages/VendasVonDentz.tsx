...
const VendasVonDentz = () => {
  ...
  // Recursos específicos do site Von Dentz para o comparativo
  const vonDentzComparisons = [
    ...
    { feature: 'Seção de Serviços Detalhada', oldSite: false, newSite: true },
    { feature: 'Galeria de Depoimentos', oldSite: false, newSite: true },
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e sofisticação, refletindo a excelência da Von Dentz Odontologia.',
  ...
  return (
    <>
      ...
      {showSplash && (
        <VonDentzSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
            ...
            <div className="relative flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-[#122737] to-[#D4A574] flex items-center justify-center flex-shrink-0">
                  <span className="text-white font-bold text-xs sm:text-sm">VD</span>
                </div>
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate text-sm sm:text-base">Von Dentz Odontologia</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl min-h-0 relative">
              ...
              >
                ...
                >
                  <iframe
                    src={SITE_URL}
                    title="Preview Von Dentz Odontologia"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">Von Dentz</span>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "A Von Dentz merece um site que transmita toda sua excelência e cuidado humanizado aos pacientes."
                </p>
