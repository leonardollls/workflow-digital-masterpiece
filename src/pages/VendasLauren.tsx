...
const VendasLauren = () => {
  ...
  const laurenComparisons = [
    ...
    { feature: 'Dark/Light Mode', oldSite: false, newSite: true },
    { feature: 'Slider Before/After', oldSite: false, newSite: true },
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e excelência, refletindo a qualidade dos serviços odontológicos.',
  ...
  return (
    <>
      ...
      {showSplash && (
        <LaurenSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
          ...
          >
            ...
            <div className="relative flex items-center justify-between gap-4 px-4 py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate">Lauren Rossarola</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl">
              ...
              >
                ...
                <iframe
                  src={SITE_URL}
                  title="Preview Lauren Rossarola"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">Lauren R.</span>
            ...
            <div className="max-w-6xl mx-auto">
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete a <strong className="text-white/90">excelência e profissionalismo</strong> em odontologia estética e reabilitação oral.
                </p>
          ...
          <section id="preview-section" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <div className="max-w-7xl mx-auto">
              ...
              <div className={`mb-8 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <FeatureComparison comparisons={laurenComparisons} />
              </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Com foco em excelência e acolhimento, a Dra. Lauren Rossarola merece um site que transmita toda essa dedicação aos pacientes."
                </p>
