...
import {
  ...
  LogoCarousel,
  DeveloperShowcase,
  AliceRodriguesSplashLoader,
  AdminPanelShowcaseAliceRodrigues,
  HostingBonusSection,
...
const VendasAliceRodrigues = () => {
  ...
  const SITE_URL = 'https://dentista-alice.vercel.app/';
  const PAYMENT_LINK = 'https://wa.me/555199437916';

  // Recursos específicos do site Alice Rodrigues para o comparativo
  const aliceComparisons = [
    { feature: 'Design Moderno e Sofisticado', oldSite: false, newSite: true },
    { feature: '100% Responsivo (Mobile First)', oldSite: false, newSite: true },
    { feature: 'SEO Otimizado para Buscas Locais', oldSite: false, newSite: true },
    { feature: 'WhatsApp Integrado com Formulário', oldSite: false, newSite: true },
    { feature: 'Galeria do Consultório Interativa', oldSite: false, newSite: true },
    { feature: 'Seção de Depoimentos de Pacientes', oldSite: false, newSite: true },
    { feature: 'Catálogo Completo de Tratamentos', oldSite: false, newSite: true },
    { feature: 'Integração com Instagram', oldSite: false, newSite: true },
    { feature: 'Alternância Tema Claro/Escuro', oldSite: false, newSite: true },
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e sofisticação, refletindo a excelência da Dra. Alice Rodrigues em Odontologia.',
  ...
  return (
    <>
      ...
      {showSplash && (
        <AliceRodriguesSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
            ...
            <div className="relative flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate text-sm sm:text-base">Alice Rodrigues Odontologia</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl min-h-0 relative">
              ...
              >
                ...
                >
                  <iframe
                    src={SITE_URL}
                    title="Preview Alice Rodrigues Odontologia"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">Alice Rodrigues</span>
              ...
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
                  ...
                  <span className="bg-gradient-to-r from-[#D4A574] via-[#E8C9A9] to-[#D4A574] bg-clip-text text-transparent">
                    Alice Rodrigues Odontologia
                  </span>
                </h1>

                {/* Subtitle */}
                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete o <strong className="text-white/90">cuidado, tecnologia e sofisticação</strong> da Dra. Alice Rodrigues — especialista em Periodontia e Implantodontia.
                </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className={`text-center mb-12 sm:mb-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
                  Por que seu consultório <span className="text-gradient">precisa</span> deste site?
                </h2>
          ...
          <section id="preview-section" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <div className="max-w-7xl mx-auto">
              ...
              <div className={`mb-8 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <FeatureComparison comparisons={aliceComparisons} />
              </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Com especialização em Periodontia e Implantodontia, a Dra. Alice Rodrigues merece um site que transmita toda essa excelência e cuidado aos pacientes."
                </p>
...
export default VendasAliceRodrigues;
