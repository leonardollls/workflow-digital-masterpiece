...
const VendasRobertaBento = () => {
  ...
  const robertaBentoComparisons = [
    ...
    { feature: 'Galeria do Consultório', oldSite: false, newSite: true },
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e cuidado, refletindo a dedicação da Dra. Roberta Bento.',
    ...
    },
    {
      ...
      description: 'SEO otimizado para aparecer nas primeiras posições nas buscas locais por odontologia.',
            ...
            <div className="relative flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate text-sm sm:text-base">Roberta Bento Odontologia</h2>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Com dedicação e cuidado em cada atendimento, a Dra. Roberta Bento merece um site que transmita toda essa excelência e humanização aos pacientes."
                </p>
...
export default VendasRobertaBento;
