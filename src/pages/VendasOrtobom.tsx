...
// Recursos específicos do site Ortobom Odontologia
...
const ortobomComparisons: ComparisonItem[] = [
  { feature: 'Design Moderno e Premium', oldSite: false, newSite: true },
  { feature: '100% Responsivo', oldSite: false, newSite: true },
  { feature: 'Modo Escuro Integrado', oldSite: false, newSite: true },
  { feature: 'Internacionalização (Multi-idiomas)', oldSite: false, newSite: true },
  { feature: 'Localizador de Unidades com GPS', oldSite: false, newSite: true },
  { feature: 'Seção de Especialidades Detalhada', oldSite: false, newSite: true },
  { feature: 'Blog com Notícias', oldSite: false, newSite: true },
  { feature: 'Depoimentos de Pacientes', oldSite: false, newSite: true },
  { feature: 'Newsletter Integrada', oldSite: false, newSite: true },
...
// Componente de comparação de recursos customizado
const FeatureComparisonOrtobom = () => {
  return (
    <div className="w-full">
      <div className="rounded-2xl overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10">
        ...
        {/* Rows */}
        {ortobomComparisons.map((item, index) => (
          <div
            key={index}
            className={`grid grid-cols-3 ${
              index !== ortobomComparisons.length - 1 ? 'border-b border-white/10' : ''
...
const VendasOrtobom = () => {
  ...
  const SITE_URL = 'https://ortobom-odontologia.vercel.app/';
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e modernidade, alinhado com 23+ anos de tradição da Ortobom.',
      accent: 'from-blue-500 to-cyan-500'
    },
    {
      icon: MessageCircle,
      title: '+60% Mais Agendamentos',
      description: 'Integração inteligente com WhatsApp e localizador de unidades otimizado para conversão de visitantes em pacientes.',
      accent: 'from-green-500 to-emerald-500'
    },
    {
      icon: Search,
      title: 'Melhor no Google',
      description: 'SEO otimizado para aparecer nas primeiras posições nas buscas por clínicas odontológicas.',
  ...
  const stats = [
    ...
    { value: '+60%', label: 'Mais Agendamentos', accent: 'from-green-500 to-emerald-600' },
  ...
  return (
    <>
      ...
      {showSplash && (
        <OrtobomSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
          ...
          >
            ...
            <div className="relative flex items-center justify-between gap-4 px-4 py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate">Ortobom Odontologia</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl">
              ...
              >
                ...
                <iframe
                  src={SITE_URL}
                  title="Preview Ortobom Odontologia"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">Ortobom</span>
            ...
            <div className="max-w-6xl mx-auto">
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete a <strong className="text-white/90">excelência e tradição</strong> de mais de 23 anos transformando sorrisos na América Latina.
                </p>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Com recursos modernos como modo escuro, multi-idiomas e localizador de unidades, a Ortobom Odontologia estará à frente da concorrência."
                </p>
