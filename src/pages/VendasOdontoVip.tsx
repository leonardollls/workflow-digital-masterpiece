...
import OdontoVipSplashLoader from '@/components/vendas/OdontoVipSplashLoader';
import AdminPanelShowcaseOdontoVip from '@/components/vendas/AdminPanelShowcaseOdontoVip';
import { 
...
const VendasOdontoVip = () => {
  ...
  const SITE_URL = 'https://odontovip-caxias.vercel.app/';
  const PAYMENT_LINK = 'https://wa.me/555199437916';

  // Recursos específicos do site OdontoVip para o comparativo
  const odontovipComparisons = [
    ...
    { feature: 'Catálogo de Serviços Completo', oldSite: false, newSite: true },
    { feature: 'Formulário de Agendamento', oldSite: false, newSite: true },
    { feature: 'Seção de Equipe Profissional', oldSite: false, newSite: true },
  ...
  const benefits = [
    {
      ...
      description: 'Site profissional que transmite confiança e excelência, refletindo a tradição da OdontoVip em Caxias do Sul.',
  ...
  return (
    <>
      ...
      {showSplash && (
        <OdontoVipSplashLoader onComplete={handleSplashComplete} duration={1200} />
      )}
            ...
            <div className="relative flex items-center justify-between gap-2 sm:gap-4 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-xl border-b border-white/10 rounded-t-2xl flex-shrink-0">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  <h2 className="text-white font-semibold truncate text-sm sm:text-base">OdontoVip Caxias</h2>
            ...
            <div className="flex-1 bg-slate-900 flex items-center justify-center overflow-hidden rounded-b-2xl min-h-0 relative">
              ...
              >
                ...
                >
                  <iframe
                    src={SITE_URL}
                    title="Preview OdontoVip Caxias"
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              >
                ...
                <div className="hidden sm:block text-left">
                  <span className="text-white font-semibold text-sm">OdontoVip</span>
            ...
            <div className="max-w-6xl mx-auto">
              <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-8 leading-relaxed">
                  Uma nova presença digital que reflete a <strong className="text-white/90">excelência e tradição</strong> da OdontoVip, clínica odontológica premium em Caxias do Sul.
                </p>
                ...
                <HeroMockup3D 
                  ...
                  staticMode
                  mockupImage="/Images/mockups-3d/odontovip-mockup-desktop.webp"
                />
              </div>
            </div>
          </section>
            ...
            <section id="preview-section" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
              <div className="max-w-7xl mx-auto">
                  ...
                  <Suspense fallback={<SectionFallback height="200px" />}>
                    ...
                    <div className="flex sm:col-span-2 lg:col-span-1 justify-center">
                      <Mockup3D 
                        siteUrl={SITE_URL} 
                        staticMode
                        mockupImage="/Images/mockups-3d/odontovip-mockup-mobile.webp"
                        onOpenFullscreen={() => {
                          setDevice('mobile');
                          setIsPreviewOpen(true);
                        }}
                ...
                <div className="mb-8">
                  ...
                  <Suspense fallback={<SectionFallback height="300px" />}>
                    <FeatureComparison comparisons={odontovipComparisons} />
                  </Suspense>
                </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <p className="text-white/40 text-sm max-w-xl mx-auto mb-8 italic">
                  "Com anos de tradição em odontologia premium, a OdontoVip merece um site que transmita toda essa excelência e cuidado aos pacientes."
                </p>
...
export default VendasOdontoVip;
